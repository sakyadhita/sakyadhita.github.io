...
- Name: join-us.spec.ts >> Join Us Form >> should toggle membership sections via checkbox
- Location: tests/join-us.spec.ts:36:3
...
Locator:  locator('#membership-sections')
Expected: hidden
Received: visible
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('#membership-sections')
    9 × locator resolved to <div id="membership-sections" data-astro-cid-wf7cagh2="" class="space-y-8 pt-8 fade-in">…</div>
    ...
    - main [ref=e29]:
        ...
        - generic [ref=e34]:
            - generic [ref=e35]:
                ...
                - generic [ref=e38]:
                    - checkbox "Not interested in membership, but want to be on the email list." [checked] [ref=e39]
